 ...
 * @author schuller
 */
public class SSHKeyAuthN implements IAuthCallback {
	...
	public SSHKeyAuthN(String user, File privateKey, PasswordSupplier password){
		this(user, privateKey, password, 300);
	}
	
	public SSHKeyAuthN(String user, File privateKey, PasswordSupplier password, long lifetime){
		this.user = user;
